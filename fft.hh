...
struct Dit<13, 13, STRIDE, TYPE, -1>
{
			...
			TYPE in0, TYPE in1, TYPE in2, TYPE in3, TYPE in4, TYPE in5, TYPE in6, TYPE in7, TYPE in8, TYPE in9, TYPE in10, TYPE in11, TYPE in12)
	{
		...
		*out1 = in0 + cx<1,13>(in1+in12) + sx<1,13>(twiddle(in1,in12)) + ex<-2,13>(in2) + ex<-3,13>(in3) + ex<-4,13>(in4) + ex<-5,13>(in5) + ex<-6,13>(in6) + ex<-7,13>(in7) + ex<-8,13>(in8) + ex<-9,13>(in9) + ex<-10,13>(in10) + ex<-11,13>(in11);
		...
		*out6 = in0 + ex<-6,13>(in1) + ex<-12,13>(in2) + ex<-5,13>(in3) + ex<-11,13>(in4) + ex<-4,13>(in5) + ex<-10,13>(in6) + ex<-3,13>(in7) + ex<-9,13>(in8) + ex<-2,13>(in9) + ex<-8,13>(in10) + ex<-1,13>(in11) + ex<-7,13>(in12);
		*out7 = in0 + ex<-7,13>(in1) + ex<-1,13>(in2) + ex<-8,13>(in3) + ex<-2,13>(in4) + ex<-9,13>(in5) + ex<-3,13>(in6) + ex<-10,13>(in7) + ex<-4,13>(in8) + ex<-11,13>(in9) + ex<-5,13>(in10) + ex<-12,13>(in11) + ex<-6,13>(in12);
		*out8 = in0 + ex<-8,13>(in1) + ex<-3,13>(in2) + ex<-11,13>(in3) + ex<-6,13>(in4) + ex<-1,13>(in5) + ex<-9,13>(in6) + ex<-4,13>(in7) + ex<-12,13>(in8) + ex<-7,13>(in9) + ex<-2,13>(in10) + ex<-10,13>(in11) + ex<-5,13>(in12);
		*out9 = in0 + ex<-9,13>(in1) + ex<-5,13>(in2) + ex<-1,13>(in3) + ex<-10,13>(in4) + ex<-6,13>(in5) + ex<-2,13>(in6) + ex<-11,13>(in7) + ex<-7,13>(in8) + ex<-3,13>(in9) + ex<-12,13>(in10) + ex<-8,13>(in11) + ex<-4,13>(in12);
		*out10= in0 + ex<-10,13>(in1) + ex<-7,13>(in2) + ex<-4,13>(in3) + ex<-1,13>(in4) + ex<-11,13>(in5) + ex<-8,13>(in6) + ex<-5,13>(in7) + ex<-2,13>(in8) + ex<-12,13>(in9) + ex<-9,13>(in10) + ex<-6,13>(in11) + ex<-3,13>(in12);
		*out11= in0 + ex<-11,13>(in1) + ex<-9,13>(in2) + ex<-7,13>(in3) + ex<-5,13>(in4) + ex<-3,13>(in5) + ex<-1,13>(in6) + ex<-12,13>(in7) + ex<-10,13>(in8) + ex<-8,13>(in9) + ex<-6,13>(in10) + ex<-4,13>(in11) + ex<-2,13>(in12);
		*out12= in0 + ex<-12,13>(in1) + ex<-11,13>(in2) + ex<-10,13>(in3) + ex<-9,13>(in4) + ex<-8,13>(in5) + ex<-7,13>(in6) + ex<-6,13>(in7) + ex<-5,13>(in8) + ex<-4,13>(in9) + ex<-3,13>(in10) + ex<-2,13>(in11) + ex<-1,13>(in12);
	}
	static inline void dit(TYPE *out, const TYPE *in, const TYPE *)
	{
